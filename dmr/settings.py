...
class HttpSpec(enum.StrEnum):
    ...
    Attributes:
        ...
        http_field_name_validation: Disables validation that HTTP
            field names conform to the token syntax
            defined in RFC 9110, Section 5.6.2.
    """
    ...
    http_field_name_validation = 'http_field_name_validation'
