...
# run: {"controller": "EntryController", "method": "get", "url": "/api/entries/", "query": "?cursor=MnwtfGF8LXwy", "populate_db": true}  # noqa: ERA001, E501
# run: {"controller": "EntryController", "method": "get", "url": "/api/entries/", "query": "?cursor=INVALID", "populate_db": true, "curl_args": ["-D", "-"], "assert-error-text": "cannot be decoded", "fail-with-body": false}  # noqa: ERA001, E501
