...
decorator, :attr:`~django_modern_rest.controller.Blueprint.responses`
...
:attr:`~django_modern_rest.controller.Blueprint.responses`
``Controller`` attribute,
...
with a :class:`~django_modern_rest.files.FileBody` marker:
