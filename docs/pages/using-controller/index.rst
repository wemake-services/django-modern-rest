...
.. note::
  ...
  Prefer :data:`~dmr.endpoint.modify` in simpler cases.

"Raw endpoints" can be either undecorated
or can use the :data:`~dmr.endpoint.modify` decorator
...
``extra_responses`` param to :data:`~dmr.endpoint.modify`,
...
"Real endpoints" can use the :data:`~dmr.endpoint.validate`
