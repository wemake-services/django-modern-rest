...
class APIController(Controller[PydanticSerializer]):
    ...
    @modify(auth=[CookieJWTSyncAuth()])
    def get(self) -> str:  # has custom auth
...
# run: {"controller": "APIController", "method": "get", "url": "/api/users/", "headers": {"Authorization": "Bearer $JWT_ACCESS_TOKEN"}, "populate_db": true, "assert-error-text": "Not authenticated", "fail-with-body": false}  # noqa: ERA001, E501
