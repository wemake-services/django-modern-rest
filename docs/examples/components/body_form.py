...
# run: {"controller": "UserController", "url": "/api/users/", "method": "put", "headers": {"Content-Type": "application/x-www-form-urlencoded"}, "body": {"username": "sobolevn", "age": "wrong"}, "curl_args": ["-D", "-"], "assert-error-text": "age", "fail-with-body": false}  # noqa: ERA001, E501
