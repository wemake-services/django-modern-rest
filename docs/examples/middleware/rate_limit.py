...
# run: {"controller": "RateLimitedController", "method": "post", "headers": {"X-Rate-Limited": "true"}, "url": "/api/ratelimit/", "curl_args": ["-D", "-"], "assert-error-text": "Rate limit exceeded", "fail-with-body": false}  # noqa: ERA001, E501
